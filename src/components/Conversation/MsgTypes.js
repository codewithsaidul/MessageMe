...
const DocMsg = ( { el } ) => {
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        <Stack p={2} direction="row" spacing={3} alignItems="center" sx={{background: theme.palette.background.paper,  borderRadius: 1}}>
            <Image size={48} />
...
const LinkMsg = ( { el } ) => {
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        <Stack p={2} spacing={3} alignItems="center" sx={{background: theme.palette.background.paper,  borderRadius: 1}}>
